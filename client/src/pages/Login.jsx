        ...
        <div className="mt-8 grid grid-cols-1 gap-4">
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-gray-900">Unlimited Reviews</h3>
                <p className="text-xs text-gray-600">Rate and review unlimited entities</p>
              </div>
            </div>
          </div>
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-gray-900">Compare Features</h3>
                <p className="text-xs text-gray-600">Compare up to 4 entities side-by-side</p>
              </div>
            </div>
          </div>
        </div>
